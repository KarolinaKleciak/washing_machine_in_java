...
public class PojemnikNaDetergenty {
    ...
    PojemnikNaDetergenty(Pralka _pralka){
        this.pralka = _pralka;
    }
    ...
    public String toString(){
        return "Pojemnik na detergenty: < jest otwarty: " + this.stan + ", " + "jest pełny: " + this.stan_2 + " >";
    }
    ...
    public void zmien_stan2(boolean stan_2){this.stan_2 = stan_2;}
